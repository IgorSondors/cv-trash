...
faces_folder_path = 'C:\\Users\\Igor\\Desktop\\Python\\exercises\\face_recognition'
...
for f in glob.glob(os.path.join(faces_folder_path, "*.jpg")):
    ...
    for k, d in enumerate(dets):
        ...
        aligned_images_list.append(face_descriptor_from_prealigned_image)
        #print(aligned_images_list, len(aligned_images_list))        
...
array1 = dlibVect_to_numpyNDArray(aligned_images_list[0])
array2 = dlibVect_to_numpyNDArray(aligned_images_list[1])


dist = np.linalg.norm(array1 - array2)
print(dist)
if float(dist) < 0.55:
    print('There are pictures of the same person')
else:
    print("There are pictures of different persons")
